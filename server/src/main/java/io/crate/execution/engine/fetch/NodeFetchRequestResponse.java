...
public class NodeFetchRequestResponse extends TransportRequest {

    private final NodeFetchRequest request;
    private final Writeable.Reader<NodeFetchResponse> responseReader;

    public NodeFetchRequestResponse(String nodeId,
                                    UUID jobId,
                                    int fetchPhaseId,
        ...
        request = new NodeFetchRequest(nodeId, jobId, fetchPhaseId, closeContext, toFetch);
        responseReader = in -> new NodeFetchResponse(in, streamers, ramAccounting);
    }

    public NodeFetchRequest createRequest() {
        return request;
    }
    ...
    public static class NodeFetchRequest extends TransportRequest {
        ...
        @VisibleForTesting
        NodeFetchRequest(String nodeId,
                         UUID jobId,
                         int fetchPhaseId,
                         boolean closeContext,
                         IntObjectMap<IntArrayList> toFetch) {
